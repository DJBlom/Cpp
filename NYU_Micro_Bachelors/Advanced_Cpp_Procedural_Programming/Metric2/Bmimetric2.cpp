// This programs purpose is to calculate the BMIi and CDC status of a person.
...
void Display(float result)
{
	...
	if (result <= 18.5)
	{
		cout << "BMI is: " << setprecision(4) << result << ", status is (Underweight)" << endl;
	}
	else if (result >= 18.5 || result <= 24.9)
	{
		cout << "BMI is: " << setprecision(4) << result << ", status is (Normal)" << endl;
	}
	else if (result >= 25.0 || result <= 29.9)
	{
		cout << "BMI is: " << setprecision(4) << result << ", status is (Overweight)" << endl;
	}
	else
	{
		cout << "BMI is: " << setprecision(4) << result << ", status is (Obese)" << endl;
	}
}
